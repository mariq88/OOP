...
namespace GeometryAPI
{
    ...
    public class Cylinder : Figure, IAreaMeasurable, IVolumeMeasurable
    {
        ...
        public double GetArea()
        {
            double sideArea = Math.PI * this.Radius * this.Radius;
            ...
            double sideTour = 2 * Math.PI * this.Radius;
            return 2 * sideArea + sideTour * height;
        }
                ...
                case "cylinder":
                    {
                        ...
                        currentFigure = new Cylinder(bottom, top, r);
                        break;
                    }
            }
